...
import org.daleon.framework.Object.GameObject;
...
public class SpatialHashGrid {
    ...
    public SpatialHashGrid(float worldWidth, float worldHeight, float cellSize) {
        ...
        this.cellsPerCol = (int) Math.ceil((float)(worldHeight/cellSize));
        this.cellsPerRow = (int)Math.ceil((float)(worldWidth/cellSize));
    ...
    public int[] getCellIds(GameObject obj) {
        int x1 = (int) Math.floor((obj.position.x - obj.bounds.width/2) / cellSize);
        int y1 = (int) Math.floor((obj.position.y - obj.bounds.height/2) / cellSize);
        int x2 = (int) Math.floor((obj.position.x + obj.bounds.width/2) / cellSize);
        int y2 = (int) Math.floor((obj.position.y + obj.bounds.height/2) / cellSize);
